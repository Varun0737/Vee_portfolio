            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="order-2 md:order-1 relative">
                        ...
                        <div className="relative glass-card p-6 rounded-xl border border-white/10">
                            <div className="flex items-center gap-4 mb-6 border-b border-white/10 pb-4">
                                ...
                                <div>
                                    <h3 className="font-cyber text-xl text-text-main">PLAYER PROFILE</h3>
                    ...
                    <div className="order-1 md:order-2">
                        <h2 className="font-cyber text-3xl md:text-4xl font-bold mb-6 text-text-main flex items-center gap-2">
